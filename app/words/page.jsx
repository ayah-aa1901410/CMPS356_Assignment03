        ...
        <FormControl>
          ...
          <fieldset aria-hidden="true" style={{ cursor: "text", borderRadius: "10px", color: suggestsList.isLoading || wordsList.isLoading? "red" : "grey" , margin: "0", padding: "0 8px", borderStyle: "solid", borderWidth:"1px"}} >
            <Paper component="form" sx={{ p: "2px 4px", display: "flex", alignItems: "center", width: 290, boxShadow: "0 0 0 0",}}>
                ...
                <InputBase onChange={queryChange} style={{height: "35px", width: "250px", outline: "none", outlineColor: "white",}} label="Search"  /*defaultValue={store.query}*/ value={store.query} autoFocus sx={{backgroundColor: isPending? "yellow": "white"}}/>
                <legend style={{borderRadius: "10px", color: suggestsList.isLoading || wordsList.isLoading? "red" : "grey",display: "block",visibility: "hidden", height: "11px", }}>
      ...
      <div style={{padding: "10px", margin: "10px", display: "flex", flexDirection: "row", justifyContent: "space-around", alignItems: "center", flexWrap: "wrap", gap: "5px"}}>
            {
              ...
              <div style={{borderRadius: "10px", border: "1px solid grey"}}>
                <Button size="small" value={word.word} onClick={queryChange} sx={{borderRadius: "10px", fontSize: "12px", outlineColor: "white"}}>
                  {word.word}
                </Button>
                <IconButton color="primary" sx={{ p: "2px" }} aria-label="directions" onClick={()=>removeWord({word: word.word})} >
                  <ClearIcon />
                </IconButton>
              </div>
            )}
